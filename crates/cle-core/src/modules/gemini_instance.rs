...
pub fn get_default_instances_root_dir() -> Result<PathBuf, String> {
    #[cfg(target_os = "macos")]
    {
        ...
        return Ok(home.join(".antigravity_cle/instances/gemini"));
    }
    ...
    #[cfg(target_os = "windows")]
    {
        ...
        return Ok(PathBuf::from(appdata).join(".antigravity_cle\\instances\\gemini"));
    }
    ...
    Err("Gemini 应用多开仅支持 macOS、Windows 和 Linux".to_string())
}
