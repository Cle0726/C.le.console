...
const CLAUDE_DESKTOP_GATEWAY_PROVIDER_PRESET_CATALOG: readonly ClaudeDesktopGatewayProviderPreset[] = [
  {
...
export const CLAUDE_DESKTOP_GATEWAY_PROVIDER_PRESETS: readonly ClaudeDesktopGatewayProviderPreset[] =
  CLAUDE_DESKTOP_GATEWAY_PROVIDER_PRESET_CATALOG.filter(isNeutralProviderPreset);
