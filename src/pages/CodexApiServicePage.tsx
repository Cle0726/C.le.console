        ...
        <section className="codex-api-service-hero">
          ...
          <div className="codex-api-service-hero-actions">
            <button
              ...
              onClick={() => {
                invoke("start_chat2api")
                  .then(() => void message("Chat2API 已成功在后台启动！", { title: "启动成功", kind: "info" }))
                  .catch((e) => void message(`启动失败: ${e}`, { title: "启动失败", kind: "error" }));
              }}
            >
              <Power size={14} />
              启动 Chat2API
            ...
            <button
              ...
              onClick={() => {
                invoke("start_aurora")
                  .then(() => void message("Aurora 已成功在后台启动！", { title: "启动成功", kind: "info" }))
                  .catch((e) => void message(`启动失败: ${e}`, { title: "启动失败", kind: "error" }));
              }}
            >
              <Power size={14} />
