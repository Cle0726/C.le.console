...
use cle_core::modules::{cursor_account, gemini_account, github_copilot_account};
use colored::*;
use tabled::{Table, Tabled};

#[derive(Parser)]
#[command(author, version, about = "C.le.控制台 CLI", long_about = None)]
struct Cli {
    #[command(subcommand)]
...
async fn main() -> anyhow::Result<()> {
    ...
    match cli.command {
        ...
        None => {
            println!("Welcome to Cle CLI! Use --help for commands.");
        }
    }
