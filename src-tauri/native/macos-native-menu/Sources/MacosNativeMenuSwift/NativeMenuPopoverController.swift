...
final class NativeMenuPopoverController: NSObject, ObservableObject, NSMenuDelegate {
    ...
    func dispatch(action: NativeRustAction) {
        ...
        case .openCleConsole:
            self.closeMenu()
            dispatchRustMenuAction(action: "open_cle_console")
        case .settings:
            self.closeMenu()
    ...
    @objc private func handleOpenCleConsole(_: Any?) {
        self.dispatch(action: .openCleConsole)
    }
    ...
    private func rebuildMenu() {
        ...
        menu.addItem(self.makeActionMenuItem(
            title: snapshot.strings.open_cle_console,
            systemName: "macwindow",
            action: #selector(self.handleOpenCleConsole(_:))
        ))
        menu.addItem(self.makeActionMenuItem(
